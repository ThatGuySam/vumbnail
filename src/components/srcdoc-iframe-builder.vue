...
function embedTemplate({
    ...
    return `<!-- Reference: https://vumbnail.com/examples/srcdoc-iframe-for-lighthouse -->
<iframe
    srcdoc="
        <style>
            body, .full {
    ...
    <section class="flex flex-col justify-center gap-5 pb-16">
        <label>
            ...
            <VideoReferenceInput
                ...
                @update:video-reference="videoReference = $event"
                @update:video-id="videoId = $event"
                @update:show-input-error="showInputError = $event"
                ...
                >
                    <div class="flex items-center gap-4">
                        ...
                        <div class="w-full flex justify-between items-center">
                            <button
                                ref="copyButton"
                                class="copy px-3 py-1 border rounded focus:bg-white"
